...
module avl {
  ...
  export class AvlNode implements IndexNode {
    height: number;
    key: IndexKey;
    value: any;
    left: AvlNode;
    ...
    constructor(key: IndexKey, value: any) {
      this.key = key instanceof bit_array.BitArray ? key: new bit_array.BitArray(key);
      this.value = value;
      this.left = null;
      this.leftRef = null;
      this.right = null
  ...
  export class AvlTree implements IndexTree {
    dbStorage: DbStorage;
    rootRef: ObjectRef;
    ...
    get(key: any, cb: ObjectCb) {
      ...
      key = key instanceof bit_array.BitArray ? key.clone() : new bit_array.BitArray(key);
