describe('util', function() {
  var JobQueue = util.JobQueue, Uid = util.Uid, Emitter = util.Emitter;
  var LinkedList = util.LinkedList, UidGenerator = util.UidGenerator;
  ...
  describe('Normalization/denormalization', function() {
    var n = util.normalize, d = util.denormalize;
